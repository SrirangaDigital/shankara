...
BookReader.prototype.prefetchImg = function(index) {
    ...
    if (loadImage) {
        ...
        if (index < 0 || index > (this.getNumLeafs() - 1) ) {
			...
			//console.log("index problem: -> " + index + " pageURI: -> " + pageURI);
			console.log(this.prefetchedImgs);
...
BookReader.prototype.blankInfoDiv = function() {
    return $([
        '<div class="BRfloat BRinfo">',
            ...
            '<p style="font-size: 16px;line-height:22px;text-align:center;color: #5a5a5a;">Digital Version of the Memorial Edition of Sri Shankaracharya\'s Works<br />Published by the Vani Vilasa Press, Srirangam.<br />20 Volumes (1910-2012)<br /><br /><a href="https://sriranga.digital/SG" target="_blank">Order online</a></p>',
